...
def loginPage(logdata):
    ...
    def check():
        for a,b,c,d in logdata:
            ...
            error = Label(login_frame,text="Wrong Username or Password!",fg='red',bg='white')
...
def easy():
    ...
    easyQ = [
                 ...
                 [
                     "Which supervillan is not a member of 'Suicide Squad' ? \nprint(“%f”%x)" ,
                    "Deadshot",
                    "The Joker",
                    "Rick Flag Jr.",
                    "Nightshade"
                ...
                [
                    ...
                    "Detective Comics"
                                ...
                                [
                    "What is the name of the dof with super-abilities that even got his own cartoon series ?" ,
                    "Streaky",
                    "Scooby Doo",
                    "Comet",
                    "Krypto"
                ...
                [
                    "Which planet does the 'Hulk' crash land on ?"
                    "Titan",
                    "Sakaar",
                    "Xandar",
                    "Nova",
...
def medium():
    ...
    mediumQ = [
                [
                    "What is the name of Wonder Woman's whip ?",
                     "Lasso of Hope",
                     "Lasso of Justice",
                     "Lasso of Truth",
                     "Lasso of Spirit"
                ...
                [
                    "Who was the first person ever to become 'The Flash' ?",
                    "Barry Allen",
                    "Wally West",
                    "jay Garick",
                    "Bart Allen"
                ...
                [
                    "What is the exact number of future scenarios that Dr. Strange saw ?",
                    "14,000,605",
                    "1,400,655",
                    "1,400,605",
                    "14,000,305"
...
def difficult():
    ...
    hardQ = [
                [
                    "In “Batman v Superman” Diana prince and Bruce Wayne meet while gazing at which ancient weapon ?",
                    "Staff of Amun-Ra",
                ...
                [
                    "What was wonder women’s original name before DC Comics changed it ?",
                    "Amazonia",
                    "She-Re",
                    "Suprema",
                    "Super Women"
                ...
                [
                    "What Top Gun character is the cat in Captain Marvel movie named after ?",
                    "Iceman",
                    "Goose",
                    "Viper",
                    "Maverick",
                ...
                [
                    "What food do the Avengers go to eat after the Battle of New York in the first Avengers film at Tony Stark's suggestion ?",
                    "Cheese Burger",
                    "Diet Coke & Pizza",
                    "Chicken Wings",
                    "Shawarma",
...
def start():
    global root 
    root = Tk()
    canvas = Canvas(root,width = 1080,height = 716, bg = 'black')
